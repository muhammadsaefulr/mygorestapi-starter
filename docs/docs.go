...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_muhammadsaefulr_NimeStreamAPI_internal_domain_dto_anilist_request.CreateAnilist"
                        }
                    }
                ],
                "responses": {}
        ...
        "/anilist/{id}": {
            "get": {
                ...
                "summary": "Get a anilist by ID",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Anilist ID (uint)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_muhammadsaefulr_NimeStreamAPI_internal_domain_dto_anilist_request.UpdateAnilist"
                        }
                    }
                ],
                "responses": {}
    ...
    "definitions": {
        ...
        "github_com_muhammadsaefulr_NimeStreamAPI_internal_domain_dto_anilist_request.CreateAnilist": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "github_com_muhammadsaefulr_NimeStreamAPI_internal_domain_dto_anilist_request.UpdateAnilist": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
